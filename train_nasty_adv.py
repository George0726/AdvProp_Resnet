...
parser.add_argument('--schedule', type=int, nargs='+', default=[120,150,170],
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='distill/', type=str, metavar='PATH',
...
# Architecture
parser.add_argument('--arch_S', '-a_S', metavar='ARCH', default='resnet50',
                    choices=model_names,
...
def train(train_loader, T_model,S_model, criterion, optimizer, epoch, use_cuda, warmup_scheduler, mixbn=False,
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        stu_loss = nn.CrossEntropyLoss()(outputs_S,targets)

        ###############  adverserial loss ########################
        T = 20
        adv_loss = nn.KLDivLoss(reduction='batchmean')(F.log_softmax(outputs_T / T, dim=1),
                                    F.softmax(outputs_S / T, dim=1)) * (T * T)   # wish to max this item

        loss = stu_loss - adv_loss * 0.005 + 100 # cifar100 0.005 cifar10 0.04
